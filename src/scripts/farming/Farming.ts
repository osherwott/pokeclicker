...
class Farming implements Feature {
    ...
    initialize(): void {
        ...
        this.berryData[BerryType.Belue]     = new Berry(BerryType.Belue,    [5000, 9800, 14500, 19800, 39600],
            ...
            ['This glossy and colorful Berry has a mouthwateringly delicious appearance. However, it is awfully sour.'], undefined,
            ['Oricorio (Sensu)']);
        //#endregion
        ...
        this.berryData[BerryType.Wacan]     = new Berry(BerryType.Wacan,    [10, 180, 900, 1800, 3600],
            ...
            ['Pikachu', 'Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        ...
        this.berryData[BerryType.Charti]    = new Berry(BerryType.Charti,   [8600, 12960, 23040, 37800, 75600],
            ...
            ['Sudowoodo', 'Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        ...
        this.berryData[BerryType.Chilan]    = new Berry(BerryType.Chilan,   [240, 1430, 2970, 7200, 14400],
            ...
            ['This Berry can be cored out and dried to make a whistle. Blowing through its hole makes an indescribable sound.'], undefined,
            ['Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        ...
        this.berryData[BerryType.Rowap]     = new Berry(BerryType.Rowap,    [5760, 9000, 14040, 21240, 42480],
            ...
            ['In days of old, people worked the top-shaped pieces of this Berry free and used them as toys.'], new Aura(AuraType.Ev, [1.005, 1.01, 1.015]),
            ['Flabébé (Blue)']);
