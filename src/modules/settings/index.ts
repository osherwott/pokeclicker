...
Settings.add(new Setting<string>('backgroundImage', 'Background image',
    ...
    'background-day'));
Settings.add(new CssVariableListSetting('custom-battle-background', 'Battle Frontier battle background',
    [
        new SettingOption('Grass', 'url(../assets/images/battleBackground/default.png)'),
        new SettingOption('Forest', 'url(../assets/images/battleBackground/forest.png)'),
        new SettingOption('Snow', 'url(../assets/images/battleBackground/snow.png)'),
        new SettingOption('Seasonal trees', 'url(../assets/images/battleBackground/fall.png)'),
        new SettingOption('Water', 'url(../assets/images/battleBackground/water.png)'),
        new SettingOption('Ocean', 'url(../assets/images/battleBackground/ocean.png)'),
        new SettingOption('Seaside Cove', 'url(../assets/images/battleBackground/cave-water.png)'),
        new SettingOption('Cave', 'url(../assets/images/battleBackground/cave.png)'),
        new SettingOption('Gem Cave', 'url(../assets/images/battleBackground/cave-gem.png)'),
        new SettingOption('Ice Cave', 'url(../assets/images/battleBackground/ice.png)'),
        new SettingOption('Desert', 'url(../assets/images/battleBackground/desert.png)'),
        new SettingOption('Magma Pit', 'url(../assets/images/battleBackground/fire.png)'),
        new SettingOption('Power Plant', 'url(../assets/images/battleBackground/power-plant.png)'),
        new SettingOption('Stage', 'url(../assets/images/battleBackground/stage.png)'),
        new SettingOption('Park', 'url(../assets/images/battleBackground/park.png)'),
        new SettingOption('Modern Building', 'url(../assets/images/battleBackground/indoors.png)'),
        new SettingOption('Abandoned Building', 'url(../assets/images/battleBackground/mansion.png)'),
        new SettingOption('Graveyard', 'url(../assets/images/battleBackground/graveyard.png)'),
        new SettingOption('Space', 'url(../assets/images/battleBackground/space.png)'),
        new SettingOption('Battlefield (Default)', 'url(../assets/images/battleBackground/battlefield.png)'),
    ],
    'url(../assets/images/battleBackground/battlefield.png)'));
