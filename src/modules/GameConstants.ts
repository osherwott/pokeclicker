...
export const Environments: Record<string, EnvironmentData> = {
    ...
    Snow: {
        ...
        [Region.sinnoh]: new Set([216, 217, 'Lake Acuity']),
    ...
    Mansion: {
        [Region.kanto]: new Set(['Pokémon Mansion']),
        [Region.johto]: new Set(['Burned Tower']),
        [Region.hoenn]: new Set(),
        [Region.sinnoh]: new Set(),
        [Region.unova]: new Set(['Liberty Garden', 'Dreamyard']),
        [Region.kalos]: new Set(['Lost Hotel']),
        [Region.alola]: new Set(['Thrifty Megamart', 'Po Town']),
        [Region.galar]: new Set(['Stow-on-Side', 11]),
    },
    ...
    Graveyard: {
        [Region.kanto]: new Set(['Pokémon Tower']),
        [Region.johto]: new Set(['Ecruteak City']),
        [Region.hoenn]: new Set(['Mt. Pyre']),
