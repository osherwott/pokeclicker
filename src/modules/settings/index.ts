...
Settings.add(new CssVariableListSetting('custom-battle-background', 'Battle Frontier battle background',
    [
        new SettingOption('Grass (Default)', 'url(../assets/images/battleBackground/default.png)'),
        ...
        new SettingOption('Ocean', 'url(../assets/images/battleBackground/water-ocean.png)'),
    ...
    'url(../assets/images/battleBackground/default.png)'));
